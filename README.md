...
Aplicación web cuyo propósito es ser una forma de pedir panchos personalizados, ya sea para delivery como pedir en el local.
## 1. Funcionalidades Principales (Presupuesto Funcional)
La aplicación web se dividirá en las siguientes secciones y funcionalidades:
...
### 1.3. Página de Mapa y Seguimiento del Delivery en Tiempo Real
...
### 1.5. Página de Información Legal (Tentativo)
* Términos y Condiciones: Información legal sobre el uso del sitio web y el servicio.
* Política de Privacidad: Detalles sobre cómo se recopilan, almacenan y utilizan los datos personales de los usuarios.
## 2. Sitemap del Sitio Web
El sitemap propuesto para la página web es el siguiente:
* Inicio: (/) - Muestra el top 5 de panchos, destacados y llamada a la acción.
* Menú: (/menu) - Página para seleccionar ingredientes y realizar el pedido.
* Seguimiento: (/seguimiento) - Página con el mapa y el seguimiento del delivery.
* Contacto: (/contacto) - Información de contacto y formulario.
* Sobre Nosotros: (/nosotros) - Información sobre la organización.
## 3. Presupuesto Temporal (Aproximado)
* Fase 1: Planificación y Diseño (1-2 semanas)
    - Implica: Creación de wireframes y prototipos de las interfaces.
    - Diseño visual de la página web (colores, tipografía, etc.).
* Fase 2: Desarrollo Front-End (3-4 semanas)
    - Implica: Implementación de la interfaz de usuario (HTML, CSS, JavaScript).
...
Nota: Cada componente a precio de mercado. En ultima instancia a definir para el ultimo draft.